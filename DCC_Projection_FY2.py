...
class PROJ_COMM():
    ...
    def proj_fy2_dcc(self):
        ...
        lookup_table = prj_gll(nlat=self.nlat, slat=self.slat, wlon=self.wlon, elon=self.elon, resLat=self.resLat, resLon=self.resLon)
...
#        #    print L1File
        ...
        p.easyplot(newLats, newLons, proj_data_num, vmin=0, vmax=10000, box=[30., -30., 60., 120.], ptype=None, markersize=20, marker='s')
        ...
        h5file_W.create_dataset('proj_data_nums', dtype='i2', data=proj_data_num, compression='gzip', compression_opts=5, shuffle=True)
        h5file_W.close()
